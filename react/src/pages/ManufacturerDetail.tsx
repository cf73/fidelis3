    ...
    return (
      <div className="min-h-screen bg-gray-50 py-12">
        <div className="container-custom text-center">
          ...
          <p className="mt-4 text-gray-600">Loading manufacturer...</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen bg-gray-50 py-12">
        <div className="container-custom text-center">
          ...
          <Link to="/manufacturers" className="btn-primary">
              ...
              <div className="flex items-center space-x-4">
                ...
                {sortedProducts.some(product => product.price) && (
                  <div className="flex items-center space-x-2">
                    <label htmlFor="price-sort" className="text-sm font-medium text-gray-700">
                      Sort by Price:
                    </label>
                    <select
                      id="price-sort"
          ...
          {sortedProducts.length === 0 ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 p-6">
              {sortedProducts.map((product) => (
                <div key={product.id} className="bg-white rounded-lg shadow-sm overflow-hidden hover:shadow-md transition-shadow duration-200 border border-gray-200">
