    ...
    >
      ...
      <section className="bg-white dark:bg-gray-800 shadow-sm">
        <div className="container-custom py-12">
          <h1 className="text-4xl font-bold text-gray-900 dark:text-white mb-4">Pre-Owned Equipment</h1>
          ...
          <div className="flex flex-col lg:flex-row gap-4">
            ...
            <div className="flex-1">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-2 border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-lg focus:ring-2 focus:ring-accent-500 focus:border-transparent"
                />
              </div>
            </div>
            ...
            <div className="flex items-center gap-2">
              <input
                ...
                className="w-24 px-2 py-2 border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-lg focus:ring-2 focus:ring-accent-500 focus:border-transparent"
              />
            ...
            <label className="flex items-center gap-2">
              ...
              />
              <span className="text-sm text-gray-700 dark:text-gray-300">Local pickup only</span>
            </label>
          </div>
        </div>
      </section>
      ...
      <section className="container-custom py-12">
        {filteredItems.length > 0 ? (
                  ...
                  >
                    ...
                    >
                      ...
                      <div className="p-6">
                          ...
                          <div className="space-y-2 text-sm text-gray-600 dark:text-gray-300">
                            ...
                            {item.local_only && (
                              <div className="flex items-center gap-2 text-accent-600 dark:text-accent-400">
                                <span className="text-xs font-medium bg-accent-100 dark:bg-accent-900/20 px-2 py-1 rounded">
                                  Local pickup only
                                </span>
                              </div>
                            )}
                        ...
                        <div className="text-center">
                          <span className="text-accent-600 dark:text-accent-400 font-medium">View Details →</span>
                        </div>
                      </div>
                    </motion.div>
                  </Link>
          ...
          <div className="text-center py-12">
            <p className="text-gray-500 dark:text-gray-400">No pre-owned items found matching your criteria.</p>
          </div>
        )}
      </section>
