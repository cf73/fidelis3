...
async function fixSigmaReview() {
  try {
    console.log('🔧 Fixing Sigma review using UUID...');
    
    // Read the Statamic file
    const fileContent = fs.readFileSync('../content/collections/products/sigma-nr-v2-1-75m.md', 'utf-8');
    ...
    console.log(`🗃️  Found product in Supabase with slug: ${currentProduct.slug}`);
    ...
    if (error) {
      ...
      console.log('✅ Successfully updated Sigma review!');
