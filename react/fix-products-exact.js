...
async function fixProductsExact() {
  console.log('🔧 Fixing products table to exact count...\n');
  ...
  try {
    ...
    // Transform the data and take only the first 356
    const cleanedData = rawData.slice(0, 356).map(row => ({
