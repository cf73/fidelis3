...
ALTER TABLE manufacturers ADD COLUMN IF NOT EXISTS image TEXT;
...
ALTER TABLE pre_owned ADD COLUMN IF NOT EXISTS image TEXT;
...
ALTER TABLE pages ADD COLUMN IF NOT EXISTS image TEXT;
