-- Fix Supabase Schema - SIMPLIFIED VERSION
...
-- Add only essential columns to products table
...
-- Add only essential columns to manufacturers table
...
-- Add only essential columns to news table
...
-- Add only essential columns to pre_owned table
...
-- Add only essential columns to testimonials table
...
-- Add only essential columns to pages table
...
-- Add only essential columns to evergreen_carousel table
